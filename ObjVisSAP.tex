...
datatype="double" or datatype="float", ucd="time.validity", unit="d" containing the date when the visibility calculations will change.}
...
datatype="double" or datatype="float",  ucd="time.start", unit="d" containing the start of the visibility period.}
...
datatype="double" or datatype="float", ucd="time.end" and unit="d" containing the end of the visibility period.}
...
datatype="double" or datatype="float", ucd="time.duration" and unit="s", containing the visibility window duration in seconds.}
...
with datatype="double" or datatype="float", ucd="pos.eq.pos\_angle" and
...
with datatype="double" or datatype="float", ucd="em.energy" and unit="m" , containing the low energy bound for this particular sky position and visibility time interval.}

\item {Exactly one field \textbf{MAY }have a name="\textbf{em\_max}" with\\
utype="\textbf{Char.Spectral.Axis.Energy.Max}"\\
with datatype="double" or datatype="float", ucd="em.energy" and unit="m" , containing the high energy bound for this particular sky position and
...
datatype="double" or datatype="float", ucd="angle.validity" and unit="deg" , containing the minimum elevation for this particular sky position and visibility
time interval.}

\item {Exactly one field \textbf{MAY }have a name="\textbf{elevation\_max}" with\\
utype="\textbf{Char.Position.Axis.Max}"\\
with datatype="double" or datatype="float", ucd="angle.validity" and unit="deg", containing the maximum elevation for this particular sky position and 
visibility time interval.}

\item {Exactly one field \textbf{MAY }have a name="\textbf{moon\_sep\_min}" 
with datatype="double" or datatype="float", ucd="angle.validity" and
...
datatype="double" or datatype="float", ucd="angle.validity" and
...
<PARAM name="accessURL" datatype="char" arraysize="*"
 ...
 <GROUP name="inputParams">
  ...
  <PARAM name="time" datatype="double" arraysize="*"	 unit="d"/>
...
Limits.StartTime  \newline
(MUST)} & time.start &
Visibility window start time (MJD) & double or float & d \\
\hline
\textbf{t\_stop} & \textbf{
Char.TimeAxis.Coverage.Bounds. \newline
Limits.StopTime \newline
(MUST)} & time.end &
Visibility widow end time (MJD) & double or float & d \\
\hline
\textbf{t\_visibility} & \textbf{
Char.TimeAxis.Coverage. \newline
Support.Extent  \newline
(MUST)} & time.duration &
Visibility duration window & double ot float & s \\
\hline
\textbf{pos\_angle} & \textbf{
Char.SpatialAxis.Coverage.Location. \newline
Coord.Position2D.Value2.C3  \newline
(MAY)} &
pos.eq.pos\_angle & Satellite position angle & double or float & deg \\
\hline
...
visibility time interval & double or float & m \\
\hline
...
separation for this sky position and visibility time interval & double or float &
deg \\
\hline
